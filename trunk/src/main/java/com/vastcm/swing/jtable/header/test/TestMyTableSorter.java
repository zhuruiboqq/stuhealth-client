...
import com.vastcm.swing.jtable.header.MyTableModel;
import com.vastcm.swing.jtable.header.MyTableSorter;
...
//										new Boolean(true) } }, headerStr);
        dm.setDataVector(new Object[][]{
                    {"b", getDate("98/12/02"), "14:12:00", new Boolean(false)},
                    {"a", getDate("99/01/01"), "0721:00:00", new Boolean(false)},
                    {"d", getDate("99/02/11"), "", new Boolean(false)},
                    {"c", getDate("99/02/27"), "", new Boolean(false)},
                    {"foo", new Date(), "25:00:11", new Boolean(true)},
                    {"bar", new Date(), "25:00:11", new Boolean(true)}}, headerStr);
